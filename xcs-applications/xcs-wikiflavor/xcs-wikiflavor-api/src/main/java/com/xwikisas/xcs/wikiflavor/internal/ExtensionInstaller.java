...
public class ExtensionInstaller
{
     ...
     * @throws com.xwikisas.xcs.wikiflavor.WikiFlavorException if problem occurs
     */
    public void installExtension(String wikiId, ExtensionId extensionId) throws WikiFlavorException
    {
        try {
            // Create the install request
            InstallRequest installRequest = new InstallRequest();
            installRequest.setId(Arrays.asList(WikiFlavorJob.JOB_ID_PREFIX, "install", wikiId));
