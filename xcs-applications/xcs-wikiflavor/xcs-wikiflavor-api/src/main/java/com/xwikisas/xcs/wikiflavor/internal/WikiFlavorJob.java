...
@Named(WikiFlavorJob.JOB_TYPE)
public class WikiFlavorJob extends AbstractJob<WikiCreationRequest, DefaultJobStatus<WikiCreationRequest>>
{
    /**
     * The prefix put behind all job ids.
     */
    public static final String JOB_ID_PREFIX = "wikiflavor";

    public static final String JOB_TYPE = "wikiflavorjob";
